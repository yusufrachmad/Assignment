...
type Service interface {
	...
	DeleteOrder(orderId int) (*dto.NewDeleteResponse, errs.Error)
}
...
func (os *orderService) DeleteOrder(orderId int) (*dto.NewDeleteResponse, errs.Error) {
	...
	response := dto.NewDeleteResponse{
